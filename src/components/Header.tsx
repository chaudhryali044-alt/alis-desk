...
export default function Header({ onBriefing, briefingLoading, onWhatsApp }: HeaderProps) {
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-lg transition-all disabled:opacity-75"
          style={{ background: waBg, color: '#fff' }}
        >
          {waStatus === 'loading' ? (
